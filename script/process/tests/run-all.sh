...
tests=(
    ...
    "script/process/tests/spec-reviewer-contract.sh"
    "script/process/tests/brief-templates.sh"
    "script/process/tests/change-classifier.sh"
    "script/process/tests/check-spec-reviewer-evidence.sh"
    ...
    "script/process/tests/check-docs-spec-reviewer-contract.sh"
