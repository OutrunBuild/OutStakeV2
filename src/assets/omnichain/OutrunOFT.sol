...
import {OutrunERC20FlashMint} from "../base/OutrunERC20FlashMint.sol";
...
abstract contract OutrunOFT is OutrunERC20FlashMint, OutrunERC20Pausable, OFTCore {
     ...
     * @param flashFeeReceiver_ Initial recipient of flash loan fees. Use address(0) to burn fees.
     */
    constructor(
        string memory name_,
    ...
    function _update(address from, address to, uint256 value)
        internal
        virtual
        override(OutrunERC20, OutrunERC20Pausable)
    {
